---
title: src-fit/lds_poisson_fit_em.cpp
summary: PLDS E-M fit type. 

---

# src-fit/lds_poisson_fit_em.cpp
...
This file partially defines a type by which Gaussian-output LDS models are fit by the expectation-maximization (EM) algorithm (`lds::gaussian::emFit_t`).
